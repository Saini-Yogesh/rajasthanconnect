  ...
  return (
    <div className="citiesPage">
      <header className="citiesHeader">
        ...
        <p>Step into the kingdoms of history, where every town tells tales of unmatched chivalry, art, and heritage.</p>
      ...
      <section className="citiesGridSection">
        {loading ? (
            ...
            {filteredCities.map(city => (
              <div className="cityCard" key={city.id}>
                <div 
                  ...
                  style={{ backgroundImage: `url(${city.imageUrl || 'https://images.unsplash.com/photo-1599661046289-e31897846e41?auto=format&fit=crop&w=600&q=80'})` }}
                >
                ...
                <div className="cityCardBody">
                  ...
                  <div className="cityCardMeta">
                    <span className="bestSeason">
                      <MapPin size={14} /> <strong>Best Time:</strong> {city.bestTime}
                    </span>
                  </div>
          ...
          <div className="noResults">
            <p>No cities found matching your search. Try searching for "Jaipur" or "Lakes".</p>
          </div>
        )}
      </section>
    </div>
